...
const Section = () => {
  return (
    <section className="flex flex-col gap-5 my-5">
      <article className="flex flex-col gap-5 mx-5 justify-center lg:items-center sm:mx-[100px]">
        <h1 className="title text-2xl text-[#FE3D99] uppercase">
        ...
        <ul className="text-xs list-disc list-inside pl-1 space-y-1">
      ...
      <article className="flex flex-col gap-5 mx-5 justify-center lg:items-center sm:mx-[100px]">
        <h2 className="title text-2xl text-[#FE3D99]">
